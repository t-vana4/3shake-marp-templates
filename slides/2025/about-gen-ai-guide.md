...
エンジニアのみなさんが生成AIという強力な武器を安心して使いこなし、
他社には真似できないスピードと品質で顧客価値を最大化するための<span class="highlight-red">**「攻めのガードレール」**</span>として、
このガイドラインを策定しました。
...
1.  **AIは「武器」である**
  <span style="font-size: 0.85em;">簡単な作業はAIに任せ、より価値の高い仕事に集中しましょう。</span>
<br>
2.  **成果物責任は「人」にある**
...
以下のような条件を満たしているかどうかを調査した上で、総合的に利用可否を判断します。
...
利用可能なツール一覧は、[『承認済みAIツールリスト』](https://www.notion.so/3shake/AI-224b1e6bcbc2808a8a04cb0b7fa13820?source=copy_link)で必ず確認してください。
<span class="highlight-red">**リストにないツールの利用は厳禁です！**</span>
...
AIの生成物はそのまま使えません。人間による品質保証が必須です。
...
<table class="agreement-table">
  ...
  <tbody>
    ...
    <tr class="level2-row">
      <td>レベル2</td>
      <td>標準的な利用</td>
      <td>本ガイドラインに則り、会社が許可したツールを利用可能</td>
    </tr>
    <tr>
      <td>レベル3</td>
      <td>高度な利用</td>
...
<div style="text-align: center; font-weight: bold; margin-top: 15px;">SlackのDMでOKです</div>
</div>
<div class="incident-box">
<h3>📋 何を報告する？</h3>
<ul>
